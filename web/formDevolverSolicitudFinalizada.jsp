<%-- 
    Document   : formDevolverEnvioConformidad
    Created on : 04/09/2011, 10:36:13 PM
    Author     : Roger
--%>
...
<html>
    <head>
        ...
        <title>Devolver Solicitud Finalizada</title>
		...
		//------------------------
			...
			$('#dialogMessage > p').html(""); 
			$('#dialogMessage > p').html("<strong>Desea regresar a la ventana anterior ...</strong>"); 
				
				$('#dialogMessage').dialog( { buttons: [ 
						{
						text: "OK", 
						click: function() {
			...
			datosCompletos = true; 
				...
				$('#dialogMessage > p').html(""); 
				$('#dialogMessage > p').html("<strong>" + mensajeDialogo + "</strong>"); 
				$('#dialogMessage').dialog({ buttons: [
								{
									text: "OK", 
									click: function() {
				...
				$('#dialogMessage').dialog({ buttons: [
								{
									text: "Reenviar", 
									click: function() {
										   document.frmDevolverSolicitudFinalizada.submit(); 	
										   //$('#frmDevolverSolicitudFinalizada').submit(); 
										   }
								}, 
								{
									text: "Cancelar", 
    ...
    <body>
    <div id="parteDetalle">
        <h3>Devolver Solicitud Finalizada</h3>
        <p>Ingrese los datos solicitados para devolver la solicitud a la persona que ha finalizado la atención ....</p>
        <jsp:include page="datosBasicosSolic.inc.jsp" />           
        <jsp:useBean class="helpdesk.web.Fecha" id="miFecha" scope="page" />
		<br/>
      <form action="controlTrabajador.do?opcion=_devolverSolicitudFinalizada" method="post" enctype="multipart/form-data" 
        		name="frmDevolverSolicitudFinalizada" id="frmDevolverSolicitudFinalizada">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td colspan="2"><label>
                <input name="txtFecha" type="text" id="txtFecha" value="${pageScope.miFecha.fechaHoraActual}" size="30" 
					readonly="true" title="Fecha de la devolucion">
              </label>              </td>
            </tr>
            <tr>
    ...
    <div id="dialogMessage" class="mensajeDialogo" title="Devolver Solicitud">
    	<p></p>
    </div>
    </body>
</html>
