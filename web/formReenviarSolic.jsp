<%-- 
    Document   : formReenviarSolic
    Created on : 23/08/2011, 09:43:46 AM
    Author     : rcontreras
--%>
...
<html>
    <head>
        ...
        <title>Reenviar la solicitud</title>
				...
				$('#dialogConfirmarReenvio').dialog({ buttons: [
								{
									text: "Reenviar", 
									click: function() {
										   document.frmReenviarSolicitud.submit(); 	
    ...
    <body>
    <div id="parteDetalle">
        <h3>Reenviar la solicitud</h3>
        <p>Ingrese los datos solicitados para reenviar su solicitud, la cual sera enviada para su atencion 
        	por informatica o su jefe inmediato dependiendo del caso ....</p>
        <jsp:include page="datosBasicosSolic.inc.jsp" />           
        <jsp:useBean class="helpdesk.web.Fecha" id="miFecha" scope="page" />
		<br/>
      <form action="controlTrabajador.do?opcion=_reenviarSolicitud" method="post" enctype="multipart/form-data" 
        		name="frmReenviarSolicitud" id="frmReenviarSolicitud">
	    <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="8%"><strong>Fecha</strong></td>
              <td colspan="2"><label>
                <input name="txtFecha" type="text" id="txtFecha" value="${pageScope.miFecha.fechaHoraActual}" size="30" readonly="true" title="Fecha de reenvio">
              </label>              </td>
            </tr>
            <tr>
              <td><strong>Detalle</strong></td>
              <td colspan="2"><label>
                <textarea name="txtDetalle" cols="40" rows="5" id="txtDetalle" title="Detalle del reenvio"></textarea>
              </label></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
