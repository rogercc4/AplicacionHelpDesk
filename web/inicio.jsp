...
<script type="text/javascript">
    ...
    Solicitudes Registradas: ${requestScope.reqRegistradas.numRegistros}    </div>
    <div class="categoria">
    <img src="imagenes/applicationFormEdit.png" width="32" height="32" />
    En proceso de atenci&oacute;n: ${requestScope.reqProcAtencion.numRegistros}</div>
    <div class="categoria">
    <img src="imagenes/iconAssign.gif" width="32" height="32" />
    Asignadas: ${requestScope.reqAsignados.numRegistros}        </div>
    <div class="categoria">
    <img src="imagenes/check.png" width="32" height="32" />
    Para dar conformidad: ${requestScope.reqDarConformidad.numRegistros}    </div>    
    <div class="categoria">
    <img src="imagenes/returnTrans.png" width="32" height="32" />
    Devueltas: ${requestScope.reqDevueltos.numRegistros}        </div>    
    <div class="categoria">
    <img src="imagenes/cancel.png" width="32" height="32" />
    Rechazadas: ${requestScope.reqRechazados.numRegistros}</div>            
  	</div>    
	</div>    
    <br/>
    <div>
    ...
    Dar Visto Bueno: ${requestScope.pendDarVistoBueno.numRegistros}    </div>
    <div class="categoria">
    <img src="imagenes/hyperPapers.png" width="32" height="32" />
    Para Atender: ${requestScope.pendParaAtender.numRegistros}    </div>
    <div class="categoria">
    <img src="imagenes/iconAssign.gif" width="32" height="32" />
    Derivadas: ${requestScope.pendDerivadas.numRegistros}   </div>
    <div class="categoria">
    <img src="imagenes/applicationFormEdit.png" width="32" height="32" />    En proceso de Atenci&oacute;n: ${requestScope.pendProcAtencion.numRegistros}    </div>    
    <div class="categoria">
    <img src="imagenes/check.png" alt="" width="32" height="32" />    Enviar para conformidad: ${requestScope.pendEnviarConformidad.numRegistros}    </div>    
    </div>
</div>
